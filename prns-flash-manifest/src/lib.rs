...
pub use provisioning::{
    provisioning_image, validate_node_name, ProvisioningAction, ProvisioningError,
    TcpClientEndpoint, TcpClientHost, WifiCredentials, CONFIG_MAGIC, CONFIG_NODE_NAME_LENGTH_OFFSET,
    CONFIG_NODE_NAME_MAX_BYTES, CONFIG_NODE_NAME_OFFSET, CONFIG_OFFSET, CONFIG_PASSWORD_MAX_BYTES,
    CONFIG_SIZE, CONFIG_SSID_MAX_BYTES, CONFIG_TCP_CLIENT_HOSTNAME_MAX_BYTES,
