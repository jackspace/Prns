...
firmware_from=""
skip_build=0
boards_csv="heltec-v4,heltec-v4-r8,t-echo,mesh-tower-v2,rak4631"
...
options:
  ...
  --boards LIST          Comma-separated board slugs (default: heltec-v4,heltec-v4-r8,t-echo,mesh-tower-v2,rak4631)
