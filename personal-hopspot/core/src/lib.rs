...
pub use flash_layout::{
    ...
    S3_16_MIB_FLASH_LAYOUT, S3_8_MIB_FLASH_LAYOUT, SOLAR_NODE_FIRMWARE_MEMORY,
    SOLAR_NODE_JOURNAL_LAYOUT, SOLAR_NODE_NODE_IDENTITY_FLASH_OFFSET,
    SOLAR_NODE_RECOVERY_BOOTLOADER_FLASH_OFFSET, SOLAR_NODE_REMOTE_CONTROL_IDENTITY_FLASH_OFFSET,
    T096_APPLICATION_DATA_END, T096_FACTORY_RESERVED_FLASH_OFFSET,
    ...
    T_ECHO_BLE_IDENTITY_FLASH_OFFSET, T_ECHO_JOURNAL_LAYOUT, T_ECHO_MIN_ARENA_BYTES,
    T_ECHO_REMOTE_CONTROL_IDENTITY_FLASH_OFFSET, T_ECHO_RESERVED_FLASH_END,
