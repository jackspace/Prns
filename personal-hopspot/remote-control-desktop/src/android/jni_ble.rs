...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleSetPsm(
    _env: JNIEnv,
    _class: JClass,
    psm: jint,
) {
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleDesiredState(
    _env: JNIEnv,
    _class: JClass,
) -> jint {
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBlePeerCapacity(
    _env: JNIEnv,
    _class: JClass,
) -> jint {
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleWorkGeneration(
    _env: JNIEnv,
    _class: JClass,
) -> jlong {
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleWaitForWork(
    _env: JNIEnv,
    _class: JClass,
    observed: jlong,
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleWakePumps(
    _env: JNIEnv,
    _class: JClass,
) {
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleIdentity(
    env: JNIEnv,
    _class: JClass,
    buffer: JByteBuffer,
) -> jint {
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleSighting(
    env: JNIEnv,
    _class: JClass,
    address: JByteBuffer,
    rssi: jint,
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleDialFailed(
    env: JNIEnv,
    _class: JClass,
    address: JByteBuffer,
) -> jboolean {
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleLinkUp(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    address: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleColumbaLinkUp(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    address: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleControlIn(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    buffer: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleControlOut(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    buffer: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleCommitControlOut(
    _env: JNIEnv,
    _class: JClass,
    conn_id: jint,
) -> jboolean {
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleL2capIn(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    buffer: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleL2capOut(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    buffer: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleDataIn(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    buffer: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleDataOut(
    env: JNIEnv,
    _class: JClass,
    conn_id: jint,
    buffer: JByteBuffer,
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleCommitDataOut(
    _env: JNIEnv,
    _class: JClass,
    conn_id: jint,
) -> jboolean {
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleL2capUp(
    _env: JNIEnv,
    _class: JClass,
    conn_id: jint,
) {
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleDisconnected(
    _env: JNIEnv,
    _class: JClass,
    conn_id: jint,
) {
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleNextClose(
    _env: JNIEnv,
    _class: JClass,
) -> jint {
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleNextDial(
    env: JNIEnv,
    _class: JClass,
    buffer: JByteBuffer,
) -> jboolean {
...
#[no_mangle]
pub extern "system" fn Java_org_personal_prns_controller_NativeBridge_nativeBleNextL2capOpen(
    env: JNIEnv,
    _class: JClass,
    buffer: JByteBuffer,
) -> jboolean {
